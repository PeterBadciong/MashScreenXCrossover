...
def filter_mash_distances(input_csv, output_csv, mash_distance_threshold):
    ...
    df['Desc1_One_Word'] = df['Description1'].apply(extract_first_word)
    df['Desc2_One_Word'] = df['Description2'].apply(extract_first_word)
    ...
    filtered_df = df[(df['Desc1_One_Word'] != df['Desc2_One_Word']) & 
